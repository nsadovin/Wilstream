...
public partial class reports_ResultsAnketa : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
       ...
       ConfigurationManager.ConnectionStrings["CCAConnectionString"];
        ...
        Excel.Workbook oBook = excel.Workbooks.Open("F:\\www\\megareport\\sbrf\\sbrf8\\template\\sberbank_outbound.xlsx"); 
          
        Excel.Worksheet Sheet = (Excel.Worksheet)oBook.Worksheets[2];
       ...
       // 
        ...
        System.IO.File.Delete("F:\\www\\megareport\\sbrf\\sbrf8\\template\\" + NameBlank + ".xlsx");
        oBook.SaveAs("F:\\www\\megareport\\sbrf\\sbrf8\\template\\" + NameBlank + ".xlsx");
        ...
        Response.WriteFile("F:\\www\\megareport\\sbrf\\sbrf8\\template\\" + NameBlank + ".xlsx");
