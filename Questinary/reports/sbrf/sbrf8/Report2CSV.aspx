<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Report2CSV.aspx.cs" Inherits="reports_ResultsAnketa" %>
...
<table border="0">
    ...
    <asp:Button ID="Button1" onclick="Button2_Click" runat="server" Font-Names="Arial" 
         Text="Экспорт в CSV" CssClass="blue unibutton" />
    <br />
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    OnSelecting="SqlDataSource_SetTimeout"  
            ...
            SelectCommand="sberbank8_reports" CancelSelectOnNullParameter="True" 
