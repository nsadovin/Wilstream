<%@ Page Title="" Language="C#" MasterPageFile="~/templates/default/MasterPage.master" AutoEventWireup="true" CodeFile="dashboard_details.aspx.cs" Inherits="dashboard_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    ...
    <h1>Газпромнефть - дашборды / Детальный по АЗС</h1>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ConnectionString="<%$ ConnectionStrings:oktell_ccwsConnectionString %>" 
            ...
            SelectCommand="gazprom_dashboard_details" CancelSelectOnNullParameter="False" 
