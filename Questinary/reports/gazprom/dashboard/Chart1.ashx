<%@ WebHandler Language="C#" Class="Chart1" %>
...
public class Chart1 : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        context.Response.AddHeader("Content-Disposition", "attachment; filename=\"chart1.Jpeg\"");
        ...
        chart1.Titles.Add(new Title() { Text = "Средняя длительность звонков по АЗС, мин", ForeColor = System.Drawing.Color.White, Font = new System.Drawing.Font("Arial", 16, System.Drawing.FontStyle.Bold) });
    ...
    private Dictionary<string, string> GetData(string dt) {
        ...
        { 
            ...
            SqlCommand myCommand = new SqlCommand("exec [dbo].[gazprom_dashboard_count_and_len] @Report =  'chart1', @StartDate = @dt, @EndDate = @dt", myConnection);
