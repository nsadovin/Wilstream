...
jQuery.fn.jmp3 = function(passedOptions){
	// hard-wired options
	var playerpath = "/gazprom/dashboard/templates/default/singlemp3player/";					// SET THIS FIRST: path to singlemp3player.swf
	...
	return this.each(function(){
		...
		if (navigator.userAgent.match("MSIE")){ this.outerHTML = this.outerHTML; }
	});
};