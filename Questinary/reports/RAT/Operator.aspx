<%@ Page Title="" Language="C#" MasterPageFile="~/templates/default/MasterPage.master" AutoEventWireup="true" CodeFile="Operator.aspx.cs" Inherits="reports_RAT_Operator" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h1>РАТ Отчеты / Отчет по операторам в разрезе скилл</h1>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    OnSelecting="SqlDataSource_SetTimeout"
            ...
            SelectCommand="RAT_3_skill_dayli" CancelSelectOnNullParameter="True" 
