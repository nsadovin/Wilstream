<%@ Page Title="" Language="C#" MasterPageFile="~/templates/default/MasterPage.master" AutoEventWireup="true" CodeFile="OnlineOperator.aspx.cs" Inherits="reports_RAT_OnlineOperator" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server"> 
    ...
    <h1>РАТ Отчеты / Онлайн по операторам</h1>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ConnectionString="<%$ ConnectionStrings:oktell_ccwsConnectionString %>" 
            ...
            SelectCommand="RAT_1_online_status" CancelSelectOnNullParameter="False" 
