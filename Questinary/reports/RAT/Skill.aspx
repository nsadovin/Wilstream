<%@ Page Title="" Language="C#" MasterPageFile="~/templates/default/MasterPage.master" AutoEventWireup="true" CodeFile="Skill.aspx.cs" Inherits="reports_RAT_Skill" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h1>РАТ Отчеты / Отчет по скилл, за каждые 15 мин</h1>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    OnSelecting="SqlDataSource_SetTimeout"
            ...
            SelectCommand="RAT_4_skill_full" CancelSelectOnNullParameter="True" 
