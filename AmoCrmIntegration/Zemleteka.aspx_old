<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Zemleteka.aspx.cs" Inherits="Zemleteka" %>
        ...
        <asp:Panel ID="PanelInfoLead"  Visible="false" runat="server">
            ...
            <asp:Table ID="TableLead" CssClass="table-borderless" runat="server">
                ...
                <asp:TableRow>
                    ...
                    <asp:TableCell><asp:TextBox ID="TextBoxTags" Width="400" CssClass="form-control" runat="server"></asp:TextBox></asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
