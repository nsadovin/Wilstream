...
public partial class MassageSchool : System.Web.UI.Page
{
    ...
    protected void ButtonUpdateAddLead_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (newLead.Count > 0)
            {
                ...
                Response.Redirect("~/MassageSchool.aspx?IdLead=" + newLead.FirstOrDefault().Id);
            }
        }
        PanelNotes.Visible = true;
        LabelMsg.Visible = true;
    ...
    protected void ButtonAddNote_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/MassageSchool.aspx?IdLead=" + crmLead.Id);
