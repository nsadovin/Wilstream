<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Jobhostel.aspx.cs" Inherits="Akvator" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
  ...
  <script type="text/javascript" src="scripts/bootstrap-datetimepicker.js"></script>
    ...
    <script type = "text/javascript"> 
      ...
      var token = "de7832a1aa9e09ead6165fd8fd047b76d6800028";
      ...
      function SearchText() {
        $(".address").autocomplete({
              ...
              success: function (obj) {
               // console.log(obj.suggestions);
                  handresponse(obj.suggestions.map(function (v) {
                      return { label: v.unrestricted_value, value: v.value, data: v.data };
                    }
                  ));
              }
            }
            ...
            , select: function (event, ui) { 
              $("#TextBoxFieldValueLead497443").val(ui.item.label);
              $("#TextBoxFieldValueMainContact492101").val(ui.item.data.postal_code);
              $("#TextBoxFieldValueMainContact492103").val(ui.item.value);
              return true;
            }
          }
        );
...
<body>
    <form id="form1" runat="server">
      ...
      <asp:HiddenField ID="HiddenFieldPlatform" runat="server" />
      <asp:HiddenField ID="HiddenFieldCallDirection" runat="server" />
      <asp:HiddenField ID="HiddenFieldIdAbonent" runat="server" />
    <div class="container-fluid">
        ...
        <asp:Panel ID="PanelInfoLead"  Visible="false" runat="server">
            ...
            <asp:Table ID="TableLead" CssClass="table-borderless" runat="server">
                ...
                <asp:TableRow>
                    <asp:TableCell>Бюджет:</asp:TableCell>
                    <asp:TableCell><asp:TextBox ID="TextBoxPrice" Width="400" CssClass="form-control" runat="server"></asp:TextBox> Руб</asp:TableCell>
                </asp:TableRow>
            </asp:Table>
            
            Поиск индекса по адресу: <asp:TextBox ID="TextBoxSearch" CssClass="address" Width="300" runat="server"></asp:TextBox>
            <br/> для нахождения индекса указывать адрес с точностью до номера дома<br>
             
            <asp:Button ID="ButtonUpdateLead" CssClass="btn btn-primary" ValidationGroup="LeadSave" OnClick="ButtonUpdateAddLead_Click" runat="server" Text="Сохранить изменения" />
        ...
        <asp:Panel ID="PanelMainContact"  Visible="false"   runat="server">
            ...
            <asp:Panel ID="PanelContacts"   runat="server">
                <asp:Table ID="TableMainContact" CssClass="table-borderless" runat="server">
                    ...
                    <asp:TableRow>
                        <asp:TableCell>Компания:</asp:TableCell>
