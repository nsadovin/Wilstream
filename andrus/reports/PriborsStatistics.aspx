<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PriborsStatistics.aspx.cs" Inherits="reports_PriborsStatistics" %>
...
<body>
    ...
    <div>
        ...
        <h1>Стастистика обращений по приборам</h1>
        ...
        <asp:Chart ID="Chart1" runat="server" DataSourceID="SqlDataSourceCalls" AlternateText="Нет данных для отображения диаграммы" Palette="Excel" Width="798px" BackImageAlignment="TopRight" BackImageWrapMode="Unscaled" Height="522px">
            <series>
                <asp:Series Name="Series1" XValueMember="Product" YValueMembers="CntCalls" ChartType="Pie" CustomProperties="PieLineColor=Black, PieLabelStyle=Outside" Label="#VALX \n(#PERCENT)">
                </asp:Series>
            </series>
            <chartareas>
            ...
            <Titles>
                <asp:Title Alignment="TopLeft" BackImageAlignment="TopRight" Font="Microsoft Sans Serif, 12pt, style=Bold" Name="Стастистика обращений по приборам" Text="Стастистика обращений по приборам" DockedToChartArea="ChartArea1" IsDockedInsideChartArea="False">
                </asp:Title>
            </Titles>
        </asp:Chart>
