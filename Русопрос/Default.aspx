                            ...
                            <asp:Panel ID="Panel64" runat="server"  Visible="false">
                               Q7. Готовы ли вы порекомендовать сухие строительные смеси перечисленных марок своим родственникам/друзьям/знакомым/коллегам? ДАЙТЕ ОТВЕТ ТОЛЬКО ПО ТЕМ МАРКАМ, КОТОРЫЕ ВЫ ПОКУПАЛИ. 
                                ...
                                <asp:Table runat="server" ID="TableQ7" OnPreRender="TableQ7_PreRender" CssClass="sorttable2" GridLines="Both" > 
                                    <asp:TableRow><asp:TableCell>1</asp:TableCell><asp:TableCell>Knauf (КНАУФ)                          </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_1" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>2</asp:TableCell><asp:TableCell>Волма                                  </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_2" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>3</asp:TableCell><asp:TableCell>Старатели                              </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_3" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>4</asp:TableCell><asp:TableCell>Основит                                </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_4" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>5</asp:TableCell><asp:TableCell>UNIS (Юнис)                            </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_5" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>6</asp:TableCell><asp:TableCell>Гипсополимер                           </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_6" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>7</asp:TableCell><asp:TableCell>Bergauf (Бергауф)                      </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_7" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>8</asp:TableCell><asp:TableCell>Церезит (Ceresit)                      </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_8" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>9</asp:TableCell><asp:TableCell>Вебер-Ветонит (WEBER Vetonit)          </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_9" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>10</asp:TableCell><asp:TableCell>Rotband (Ротбанд)                     </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_10" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>11</asp:TableCell><asp:TableCell>Крепс                                 </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_11" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>12</asp:TableCell><asp:TableCell>Плитонит                              </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_12" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    ...
                                    <asp:TableRow><asp:TableCell>15</asp:TableCell><asp:TableCell>Форман                                </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_15" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>16</asp:TableCell><asp:TableCell>Геркулес                              </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_16" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>17</asp:TableCell><asp:TableCell>Боларс                                </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ7_17" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                </asp:Table>
                                <br/> 
                            ...
                            <asp:Panel ID="Panel71" runat="server" Visible="false">  
                             ...
                             <!-- Old Q13 --> 
                                ...
                                <asp:Panel ID="Panel70" runat="server"  Visible="false"> 
                                    ...
                                    <asp:TableRow><asp:TableCell>1</asp:TableCell><asp:TableCell>Knauf (КНАУФ)                      </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ13_1" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>2</asp:TableCell><asp:TableCell>Danogips (Даногипс)                </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ13_2" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>3</asp:TableCell><asp:TableCell>Волма                              </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ13_3" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>4</asp:TableCell><asp:TableCell>Gypsotonne (Гипсотон)              </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ13_4" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>5</asp:TableCell><asp:TableCell>Gyproc (Гипрок)                    </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ13_5" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>6</asp:TableCell><asp:TableCell>Magma (Магма)                      </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ13_6" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>7</asp:TableCell><asp:TableCell>Гипсополимер                       </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ13_7" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>8</asp:TableCell><asp:TableCell>Aksolit (Аксолит)                  </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ13_8" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>9</asp:TableCell><asp:TableCell>Gifas (Гифас)                      </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ13_9" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    <asp:TableRow><asp:TableCell>10</asp:TableCell><asp:TableCell>Иркутский Гипсовый Завод          </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ13_10" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                    ...
                                    <asp:TableRow><asp:TableCell>12</asp:TableCell><asp:TableCell>Ангарский Гипсовый завод          </asp:TableCell><asp:TableCell><asp:RadioButtonList ID="DropDownListQ13_12" runat="server"><asp:ListItem Value="1">Точно да</asp:ListItem><asp:ListItem Value="2">Скорее да</asp:ListItem><asp:ListItem Value="3">Скорее нет</asp:ListItem><asp:ListItem Value="4">Точно нет</asp:ListItem></asp:RadioButtonList></asp:TableCell></asp:TableRow>
                                </asp:Table>
                                <br/> 
