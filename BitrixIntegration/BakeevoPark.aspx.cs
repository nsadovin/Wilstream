...
public partial class BakeevoPark : System.Web.UI.Page
{
    Bitrix24 BX24;
    Int32 IdLead = 0;
    string Phone = "";
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        BX24 = new Bitrix24(HttpContext.Current, "local.5e343f4281b4c3.15962374", "bzRQaKfx3N8I2NszJlor8QDXl90cnY1PKsQqAXqIbWJN3yIQfN", "https://bakeevo.bitrix24.ru", "https://oauth.bitrix.info", "marketing@bakeevopark.ru", "P4nPHFC8Vm");
    ...
    protected void ButtonSaveLead_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (IdLeadOld == 0)
            {
                Response.Redirect("~/BakeevoPark.aspx?IdLead=" + IdLead);
                Response.End();
            }
        }
        catch (Exception ex)
