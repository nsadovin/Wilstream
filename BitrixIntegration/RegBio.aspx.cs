...
public partial class RegBio : System.Web.UI.Page
{
    Bitrix24 BX24;
    Int32 IdLead = 0;
    Int32 IdCampaign = 0;
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        BX24 = new Bitrix24(HttpContext.Current, "local.5e6366c7b5b046.63199819", "RwSdKiMWacHu275q7T9b1f1aB36BkxWB7MHw5D8HSbOdi2BkFh", "https://sevan.bitrix24.ru", "https://oauth.bitrix.info", "boychenko@sevancert.am", "Bychkova73");
    ...
    protected void ButtonSaveLead_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            var IdCampaign = HiddenFieldIdCampaign.Value != "" ? Convert.ToInt32(HiddenFieldIdCampaign.Value) : 0;
            ...
            if (IdLeadOld == 0)
            {
                Response.Redirect("~/RegBio.aspx?IdLead=" + IdLead);
                Response.End();
            }
            else {
