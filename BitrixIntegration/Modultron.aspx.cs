...
public partial class Modultron : System.Web.UI.Page
{
    Bitrix24 BX24;
    Int32 IdLead = 0;
    Int32 IdTask = 0;
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        BX24 = new Bitrix24(HttpContext.Current, "local.5f3d8221baf308.35921081", "iPSI4mQS8HftaCZDUMvNFkJ4E4wXxdFkMVSTeaS7rgfEUIerQ5", "https://modultron.bitrix24.ru", "https://oauth.bitrix.info", "callcenter@banya.one", "ZauAEt7a");
    ...
    {  
        ...
        foreach (var df in FilterDealFields )
        {
            var uf = fields.FirstOrDefault(r => r.ID == df);
            if (uf.USER_TYPE_ID == Bitrix24.USER_TYPE_ID.enumeration)
            {
                if (uf.MULTIPLE == Bitrix24.MULTIPLE.Y)
                {
