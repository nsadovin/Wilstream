...
public partial class SmartBazar : System.Web.UI.Page
{
    Bitrix24 BX24;
    Int32 IdLead = 0;
    string Phone = "";
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        BX24 = new Bitrix24(HttpContext.Current, "local.5f3ce274412e70.90823608", "JEudI6GJh83lWlj6NbvIXkroxKUzng5WbYeN4ZJ2x1DDTDMPdE", "https://portal.smart-bazar.ru", "https://oauth.bitrix.info", "ryzhkova@wilstream.ru", "wilstream2020");
    ...
    protected void ButtonSaveLead_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (IdLeadOld == 0)
            {
                ...
                Response.Redirect("~/SmartBazar.aspx?IdLead=" + IdLead);
                Response.End();
            }
            else
            {
